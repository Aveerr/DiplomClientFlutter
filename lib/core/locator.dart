...
import 'package:music_player/core/repositories/music_store_repository.dart';
...
import 'package:music_player/feature/player/data/player_data_store.dart';
...
Future<void> _initServices() async {
  _getIt
    ...
    ..registerFactory(() => MusicStoreRepository());
}

Future<void> _registerBlocs() async {
  _getIt
    ..registerLazySingleton(() => PlaylistBloc(_getIt.get(), _getIt.get()))
